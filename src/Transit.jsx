...
const Transit = () => (
  <div className="transit">
    ...
    <h4 className="subheader">Exoplanet Transits</h4>
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/TransitMovTable_wm.gif" alt="Single Transit" className="vertical" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/OrbitZoom_wm_quick.gif" alt="Periodic Transits" className="vertical" />
    <p>
    ...
    <h4 className="subheader">Multiple Planet Systems</h4>
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/PlanetInteractions.png" alt="Gravitational Perturbations" className="horizontal" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/pre_wm.gif" alt="Exoplanet Precession" className="vertical" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/PrecessionFig.png" alt="Transit Precession" className="scale-down" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/119_spec_stacktrans_lc_top.png" alt="Kepler-108 Top" className="horizontal"/>
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/spec_stacktrans_lc_bottom.png" alt="Kepler-108 Bottom" className="horizontal" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/animated_wm.gif" alt="" className="vertical scale-left" />
    <p>
    ...
    <h4 className="subheader">Multiple Star Systems</h4>
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/apj517318f8_hr.jpg" alt="" className="horizontal" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/3151_transits.png" alt="" className="horizontal" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/3151_orbit_hq_gaps_wm_crop.gif" alt="" className="horizontal" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/3151_trans_hq_wm_crop.gif" alt="" className="horizontal" />
    <p>
    ...
    <h4 className="subheader">Planet System Formation and Evolution</h4>
    <p>
    ...
    <div>
      <audio controls className="sound">
        <source src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/223_v2.mp3" type="audio/mpeg"/>
      </audio>
    </div>
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/223_librate_wm.gif" alt="" className="vertical" />
    <p>
    ...
    <img src="https://s3-us-west-2.amazonaws.com/www.seanmills.website/smm-media/mig.gif" alt="" className="horizontal" />
    <h6>Animation courtesy of Daniel Fabrycky and Cezary Migazewski</h6>
  </div>
);
