...
const Transit = () => (
  <div className="transit">
    ...
    <img src={TransitMovTable} alt="Single Transit" className="vertical" />
    <p>
    ...
    <img src={OrbitZoom} alt="Periodic Transits" className="vertical" />
    <p>
    ...
    <img src={PlanetInteract} alt="Gravitational Perturbations" className="horizontal" />
    <p>
    ...
    <img src={Precession} alt="Exoplanet Precession" className="vertical" />
    <p>
    ...
    <img src={PrecessionFace} alt="Transit Precession" className="scale-down" />
    <p>
    ...
    <img src={K108top} alt="Kepler-108 Top" className="horizontal"/>
    <img src={K108bottom} alt="Kepler-108 Bottom" className="horizontal" />
    <p>
    ...
    <img src={K108Animate} alt="" className="vertical scale-left" />
    <p>
    ...
    <img src={K3151Architecture} alt="" className="horizontal" />
    <p>
    ...
    <img src={K3151Transits} alt="" className="horizontal" />
    <p>
    ...
    <img src={K3151Orbit1} alt="" className="horizontal" />
    <p>
    ...
    <img src={K3151Orbit2} alt="" className="horizontal" />
    <p>
    ...
    <img src={K223Librate} alt="" className="vertical" />
    <p>
    ...
    <img src={K223Mig} alt="" className="horizontal" />
