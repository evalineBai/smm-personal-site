...
const Activity = () => (
  <div className="activity">
    ...
    <div className="teaching">
      <div>
        <h5 className="entry-header">University of Chicago Teaching Assistant</h5>
        <p className="entry">
          ...
          <CardBody className="card-body">
            ...
            >
              <CardTitle className="card-title">
                Astronomers find a system of planets that keep each other in the
                tightest formation seen
              </CardTitle>
            </a>
